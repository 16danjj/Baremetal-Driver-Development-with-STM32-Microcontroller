...
#define NUMBER_PRIORITY_BITS_IMPLEMENTED	4
...
/*
 * AHBx and APBx Bus Peripheral base addresses. The registers of the peripherals
 * hanging on these respective buses are also within these addresses
 */
...
#define NVC_IRQ_PRIO0			0
#define NVC_IRQ_PRIO15			15
